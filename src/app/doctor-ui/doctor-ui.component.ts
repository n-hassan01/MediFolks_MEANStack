...
import { faPen, faPenNib, faPenToSquare, faSquarePen } from '@fortawesome/free-solid-svg-icons';
...
export class DoctorUiComponent implements OnInit {
  ...
  constructor(private dialog: MatDialog, private api: ApiService, private route: Router, public login: AuthenticationService){
